        ...
        <div className="mt-8 mb-6 font-satoshi w-full">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-end w-full">
                ...
                <div className="md:col-span-2">
                    <Button 
                        className={`${elementHeight} w-full bg-arcipta-blue-primary hover:bg-arcipta-blue-primary/90 text-white rounded-lg shadow-sm transition-all active:scale-95 font-bold text-[11px] uppercase tracking-widest`} 
                        onClick={onReset}
                    >
